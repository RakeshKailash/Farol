<p class="page_title"><i class="material-icons">add</i><i class="material-icons">book</i>Biblioteca</p>
<a href="<?=base_url('sistema')?>" class="btn btn_table_action"><i class="material-icons">arrow_back</i>Voltar</a><a href="<?=base_url('sistema/Biblioteca/novo')?>" class="btn btn_table_action">Novo</a>
