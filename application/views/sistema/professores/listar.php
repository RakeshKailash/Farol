...
<a href="<?=base_url('sistema')?>" class="btn btn_table_action"><i class="material-icons">arrow_back</i>Painel</a><a href="<?=base_url('sistema/Professores/novo')?>" class="btn btn_table_action">Novo</a>
...
<table id="alunos_visualizar_table">
	...
	<?php foreach ($professores as $professor) : ?>
		<?php if (!$professor->status)continue; ?>
