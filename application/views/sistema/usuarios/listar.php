...
<a href="<?=base_url('sistema')?>" class="btn btn_table_action"><i class="material-icons">arrow_back</i>Painel</a><a href="<?=base_url('sistema/Usuarios/novo')?>" class="btn btn_table_action">Novo</a>
...
<table id="alunos_visualizar_table">
	...
	<tbody>
		<?php foreach ($usuarios as $usuario) : ?>
			<?php if (!$usuario->status)continue; ?>
