...
<p class="page_title"><i class="material-icons">assignment_ind</i>Nova inscrição</p><a href="<?=base_url('sistema/Inscricoes')?>" class="btn btn_table_action"><i class="material-icons">arrow_back</i>Voltar</a>
<?php if ($errors): ?>
